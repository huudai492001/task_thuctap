      ...
      <li class="nav-item">
        <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
          ...
          <span>
            ...
            <span class="sidebar-text" style="color: #fb503b;">User Manager</span>
          </span>
...
{{--                          PRODUCT MANAGER                              --}}
        ...
        <li class="nav-item">
        <span
            class="nav-link {{ Request::segment(1) !== 'list-product' ? 'collapsed' : '' }} d-flex justify-content-between align-items-center"
          ...
          <span>
            ...
            <span class="sidebar-text">Category Manager</span>
          </span>
          <span class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd"
            ...
            <div class="multi-level collapse {{ Request::segment(1) == 'list-product' ? 'show' : '' }}" role="list"
                 id="submenu-category" aria-expanded="false">
                <ul class="flex-column nav">
                    <li class="nav-item {{ Request::segment(1) == 'list-product' ? 'active' : '' }}">
