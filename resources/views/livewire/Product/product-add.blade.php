<x-layouts.base>
    ...
    <main class="content">
        ...
        <div>
            ...
            <div class="row">
                {{--                cho hang ngang 12/12 --}}
                <div class="col-12 col-xl-12">
                    <div class="card card-body border-0 shadow mb-4">
                        <h2 class="h4 mb-4 text-center">Category Add</h2>
                        {{--        Form Add Category--}}
                        ...
                        <form action="{{route('product.store')}}" method="post">
                            ...
                            <div class="col-md-12 ">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="category_id" class="form-select mb-0" type="text"
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div>
                                            <label for="first_name">Price Product</label>
                                            <input class="form-control" id="first_name" name="price" type="number"
                                                   placeholder="Enter product name" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="card card-body border-0 shadow mb-4">
                                        <h2 class="h5 mb-4">Select product photo</h2>
                                        <div class="d-flex align-items-center">
                                            <div class="me-3">
                                                <!-- Avatar -->
                                                <img class="rounded avatar-xl" src="{{asset('upload/img1.jpg')}}" alt="change avatar">
                                            </div>
                            ...
                            <div class="row text-center align-items-center">
                                <div class="form-check form-switch d-flex ">
                                    <input class="form-check-input" style="margin-left: 2px"  name="display" type="checkbox"
{{--                                           value="{{ old('display', isset($categories) ? 'checked' : '') }}"--}}
                                           id="flexSwitchCheckChecked" checked>
                                    <label class="form-check-label " style="margin: 0 0 0 10px;" for="flexSwitchCheckChecked">Display</label>
                                </div>
