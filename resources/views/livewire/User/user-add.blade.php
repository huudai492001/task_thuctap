<x-layouts.base>
    ...
    <main class="content">
        ...
        <title>Form User Information</title>
        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="phone" name="password" value="{{auth()->user()->password}}" type="password"
                                               placeholder="+12-345 678 910">
                                    </div>
                                </div>
                            </div>
                            <h2 class="h5 my-3">Location</h2>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="zip" name="zip" type="tel" placeholder="ZIP">
                                    </div>
                                </div>
                            </div>
                            <div class="mt-3">
                                ...
                                <div>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="user-notification-2" checked
                                               value="{{ old('display', isset($users) ? 'checked' : '') }}">
