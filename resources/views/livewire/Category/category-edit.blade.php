            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-12">
                    <div class="card card-body border-0 shadow mb-4">
                        <h2 class="h4 mb-4 text-center">Category Edit</h2>
                        {{--        Form Add Category--}}
                        ...
                        <form action="{{route('category.update', $category->id )}}" method="post">
                            ...
                            <div class="col-md-12 ">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div>
                                        <label for="first_name">Sub Category of</label>
                                        <input class="form-control" value="{{$category->name}}" id="first_name" name="name" type="text"
